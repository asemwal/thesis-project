...
# This allows declaration	use BGPmon::XFBReader ':all';
...
BGPmon::XFBReader - Perl extension for blah blah blah

=head1 SYNOPSIS

  use BGPmon::XFBReader;
  blah blah blah

=head1 DESCRIPTION

Stub documentation for BGPmon::XFBReader, created by h2xs. It looks like the
