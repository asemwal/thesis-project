...
file = open('/home/asemwal/raw_data/experiments/results/impact_visibility_monsize5'+gname,'r')
...
for i in keys:
    ...
    plt.savefig('visibilityimpact_monsize__'+str(i)+gname+'.pdf', format='pdf', dpi=5000)
    plt.show()